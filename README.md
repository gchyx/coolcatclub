...
_Update (4/2/2026): I re-arranged the files where each components(`networking.tf`, `ECR.tf`, `EKS.tf`, `backend.tf`) are in a separate `.tf` file. For the EC2 instance, I placed it in another folder called `ec2`. This is in case I want to deploy the website in a single EC2 instance rather than hosting it in a EKS cluster to save cost._
...
### 🎥 Learning Resources
- **[Sanjeev Thiyagarajan](https://www.youtube.com/@SanjeevThiyagarajan):** Their tutorial on **[Terraform](https://www.youtube.com/watch?v=b1P2AH9bjpI)** provided the foundation for my initial networking setup.
...
_Thank you so much for visiting!_
